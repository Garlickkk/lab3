...
// Создание стека через ввод с клавиатуры
...
void mapReduceTasks() {
    if (isStackMode) {
        ...
        Sequence<int>* seq = stackToSequence(currentStack); // Преобразуем стек в п-ть
